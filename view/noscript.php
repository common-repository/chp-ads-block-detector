<noscript>
    <div class="<?php echo esc_attr($this->rclass("modal")); ?> <?php echo esc_attr($this->rclass("show")); ?>">
        <div
            class="<?php echo esc_attr($this->rclass("content")); ?> <?php echo esc_attr($this->rclass('fadeInDown')); ?>">
            <div class="<?php echo esc_attr($this->rclass("body")); ?>"
                id="<?php echo esc_attr($this->rclass("body")); ?>">
                <div class="<?php echo esc_attr($this->rclass("theme")); ?> theme1">
                    <div class="<?php echo esc_attr($this->rclass("body")); ?>">
                        ...
                        <div class="<?php esc_attr($this->rclass("action")); ?>">
                            ...
                            <a class="<?php echo esc_attr($this->rclass("action-btn-ok")); ?>"
                                href="<?php echo add_query_arg( $wp->query_vars, home_url( $wp->request ) ); ?>"><?php echo esc_attr(@$this->settings->btn1_text); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
